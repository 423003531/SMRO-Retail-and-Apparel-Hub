...
<div class="container"> 
    <h1 class="h3 mb-3"><strong><?= $role['role_name'] ?? 'Role'; ?></strong> Access Menu </h1> 
    <div class="card"> 
                ...
                <table class="table table-hover my-0"> 
                    ...
                    <tbody> 
                        <?php foreach ($MenuCategories as $menuCategory) : ?> 
                            <tr> 
                                <td colspan="2" class="fw-bold"> <?= $menuCategory['menu_category'] ?? 'Unknown Category'; ?></td> 
                                <td> 
                            ...
                            <?php foreach ($Menus as $menu) : if ($menu['menu_category_id'] == $menuCategory['id']) : ?> 
                                <tr> 
                                    <td> &emsp; <?= $menu['title'] ?? 'Unknown Menu'; ?></td> 
                                ...
                                <?php foreach ($Submenus as $subMenu) :  if ($menu['id'] == $subMenu['menu_id']) : ?> 
                                    <tr> 
                                        <td> 
                                            <p class="ms-4"> &emsp; &emsp; <?= $subMenu['submenu_title'] ?? 'Unknown Submenu'; ?></p> 
                                        </td> 
